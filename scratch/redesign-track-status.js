...
function TrackComplaint() {
  ...
  // User's own grievances for quick tracking
  ...
  // Fetch user's registered grievances for quick track list
  useEffect(() => {
    if (user) {
      const fetchUserComplaints = async () => {
        try {
          ...
          console.warn("Could not load user quick grievances:", err.message);
        } finally {
  ...
  return (
    <div className="track-layout-clean">
      <div className="track-inner-container">
        ...
        {/* Top Search & Docket Selector Panel */}
        <div className="track-search-header-panel">
          ...
          <p>
            Enter your Docket Tracking ID to view real-time investigation milestones, nodal officer remarks, and statutory settlement notices.
          </p>
        ...
        {error && (
          <div className="track-error-alert-box">
            ...
            <div className="err-text">
              <strong>Docket Lookup Failed</strong>
              <p>{error}</p>
            </div>
          </div>
        )}

        {/* When Complaint Found: High-End Decent Structured Box Panels */}
        {complaint && (
        ...
        {/* DEFAULT VIEW: Grievance Lifecycle & Status Overview */}
        {!complaint && !loading && !error && (
          <div className="tracking-status-overview-panel">

            {/* Explainer Box: How Grievance Tracking Works */}
            <div className="lifecycle-header-box">
              <div className="lifecycle-icon-wrap">
                <FaBalanceScale />
              </div>
              <h2>Statutory Grievance Redressal Lifecycle</h2>
              <p>
                Every grievance filed on the Consumer Trust Portal undergoes strict statutory SLA tracking under the Consumer Protection Act 2019.
              </p>
            </div>

            {/* 4 Status Stage Cards */}
            <div className="status-lifecycle-grid">
              {/* Stage 1 */}
              <div className="status-stage-card stage-pending">
                <div className="stage-top-row">
                  <span className="stage-number">01</span>
                  <span className="stage-status-badge pending">Pending</span>
                </div>
                <h4>Grievance Lodged & Formal Notice</h4>
                <p>
                  Grievance is cryptographically logged with a Unique Tracking Docket ID. An official statutory notice is immediately dispatched to the enterprise nodal desk.
                </p>
                <div className="stage-sla-tag">⏱️ 24–48 Hours Acknowledgment</div>
              </div>

              {/* Stage 2 */}
              <div className="status-stage-card stage-progress">
                <div className="stage-top-row">
                  <span className="stage-number">02</span>
                  <span className="stage-status-badge progress">In Progress</span>
                </div>
                <h4>Nodal Officer Investigation</h4>
                <p>
                  Company Grievance Officer reviews dispute facts, transaction receipts, invoice proof, and seller logs to determine remedy options.
                </p>
                <div className="stage-sla-tag">🔍 Active Investigation</div>
              </div>

              {/* Stage 3 */}
              <div className="status-stage-card stage-sla">
                <div className="stage-top-row">
                  <span className="stage-number">03</span>
                  <span className="stage-status-badge sla">7-Day SLA</span>
                </div>
                <h4>Statutory SLA & Ombudsman Guarantee</h4>
                <p>
                  Enterprises are mandated to resolve disputes within 7 calendar days. If breached, 1-click Ombudsman escalation unlocks for NCH (1915), RBI, or e-Daakhil.
                </p>
                <div className="stage-sla-tag">⏳ Mandatory 7-Day Limit</div>
              </div>

              {/* Stage 4 */}
              <div className="status-stage-card stage-resolved">
                <div className="stage-top-row">
                  <span className="stage-number">04</span>
                  <span className="stage-status-badge resolved">Resolved</span>
                </div>
                <h4>Settlement & Certified Resolution</h4>
                <p>
                  Refund, replacement, or claim settlement is issued with a certified settlement reference and downloadable Resolution Certificate.
                </p>
                <div className="stage-sla-tag">✅ Certified Settlement</div>
              </div>
            </div>

            {/* Ombudsman Escalation Portals Directory */}
            <div className="statutory-ombudsman-directory">
              <div className="omb-dir-header">
                <FaLandmark className="omb-dir-icon" />
                <div>
                  <h3>Recognized Statutory Ombudsman Escalation Portals</h3>
                  <p>National dispute redressal authorities connected with Consumer Trust</p>
                </div>
              </div>

              <div className="omb-dir-grid">
                <a
                  href="https://consumerhelpline.gov.in"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="omb-dir-card"
                >
                  ...
                  <FaExternalLinkAlt className="dir-link-ico" />
                </a>
                ...
                >
                  ...
                  <div className="dir-info">
                    <strong>RBI Integrated Ombudsman (CMS)</strong>
                    <span>Banking, Cards, Digital Payments & UPI Redressal</span>
                  </div>
                  <FaExternalLinkAlt className="dir-link-ico" />
                </a>
                ...
                >
                  <span className="dir-icon">⚖️</span>
                  <div className="dir-info">
                    <strong>e-Daakhil Consumer Commission</strong>
                    <span>Online Filing in District, State & National Consumer Forums</span>
                  </div>
                  <FaExternalLinkAlt className="dir-link-ico" />
                </a>
              </div>
            ...
            {/* Quick Action Footer */}
            <div className="track-quick-footer">
              <span>Have a consumer grievance to lodge?</span>
              <Link to="/register" className="track-register-cta">
                File a New Grievance <FaArrowRight />
              </Link>
            </div>
