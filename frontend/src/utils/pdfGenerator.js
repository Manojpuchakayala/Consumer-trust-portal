// High-Resolution Consumer Grievance Claim Summary & Resolution Certificate PDF Generator
...
'    .docket-badge { display: inline-block; background: #eff6ff; color: #1e40af; border: 1px solid #bfdbfe; padding: 3px 12px; border-radius: 12px; font-size: 10px; font-weight: 800; letter-spacing: 1px; margin-top: 6px; }' +
...
'    .seal-circle { display: inline-block; border: 2px dashed #1d4ed8; color: #1d4ed8; padding: 6px 14px; border-radius: 8px; font-size: 11px; font-weight: 800; text-transform: uppercase; }' +
'    .disclaimer-text { margin-top: 14px; font-size: 9.5px; color: #64748b; text-align: center; line-height: 1.4; border-top: 1px dashed #cbd5e1; padding-top: 8px; }' +
...
'    <div class="govt-sub">Consumer Trust Platform • Independent Consumer Support & Mediation Facilitation</div>' +
'    <div class="docket-badge">CONSUMER GRIEVANCE SUMMARY DOCKET</div>' +
'  </div>' +
'  <div class="meta-bar">' +
...
'  </div>' +
'  <div class="sla-box">' +
'    <strong>⚡ Voluntary Redressal Request & Facilitation Timeline:</strong><br>' +
'    This dispute summary has been compiled via the Consumer Trust platform for prompt amicable review by the grievance officer of ' + (complaint.companyName || "the enterprise") + '. The complainant requests acknowledgment within 48 hours and dispute resolution within 7 days. If unresolved through voluntary facilitation, the complainant reserves the right to escalate via statutory mechanisms including the National Consumer Helpline (1915), Sectoral Ombudsmen (RBI/TRAI), or e-Daakhil Consumer Commission courts.' +
'  </div>' +
'  <div class="footer">' +
'    <div><strong>Live Tracking Link:</strong><br>' + trackingUrl + '</div>' +
'    <div class="seal-circle">🛡️ Digitally Verified Docket</div>' +
'  </div>' +
'  <div class="disclaimer-text">' +
'    <strong>LEGAL DISCLAIMER:</strong> Consumer Trust is an independent private facilitation platform and is not a government agency, court, or statutory commission. This document is a structured summary of the consumer\'s claim and does not constitute a judicial order or legal representation.' +
'  </div>' +
'</body>' +
'</html>';
...
'    .cert-title { font-size: 22px; font-weight: 800; color: #15803d; text-transform: uppercase; letter-spacing: 1.5px; margin: 4px 0 0; }' +
'    .cert-sub { font-size: 12px; color: #64748b; }' +
'    .cert-body { text-align: center; max-width: 750px; margin: 0 auto; }' +
'    .cert-text { font-size: 14.5px; color: #334155; margin: 16px 0; }' +
'    .party-name { font-size: 18px; font-weight: 800; color: #0f172a; text-decoration: underline; }' +
...
'    .seal-wrap { display: flex; justify-content: space-between; align-items: flex-end; margin-top: 24px; padding-top: 14px; border-top: 1px solid #dcfce7; }' +
'    .seal-badge { border: 2px solid #15803d; color: #15803d; padding: 6px 16px; border-radius: 50px; font-size: 11.5px; font-weight: 800; text-transform: uppercase; }' +
'    .cert-disclaimer { font-size: 9px; color: #94a3b8; text-align: center; margin-top: 12px; }' +
'    .print-actions { text-align: center; margin-bottom: 16px; }' +
...
'      <h1 class="cert-title">Certificate of Consumer Grievance Resolution</h1>' +
'      <div class="cert-sub">Consumer Trust Platform • Enterprise Settlement Summary Record</div>' +
'    </div>' +
'    <div class="cert-body">' +
'      <p class="cert-text">' +
'        This record confirms that the consumer dispute registered under Docket Reference <strong>' + complaint.complaintId + '</strong> filed by <span class="party-name">' + (complaint.name || "Consumer") + '</span> has been formally reviewed, settled, and redressed by <strong>' + (complaint.companyName || "the Enterprise") + '</strong>.' +
'      </p>' +
...
'    </div>' +
'    <div class="seal-wrap">' +
'      <div><div style="font-size: 11px; color: #64748b;">Facilitation Record</div><div style="font-size: 12px; font-weight: 700; color: #0f172a;">Consumer Trust Platform</div></div>' +
